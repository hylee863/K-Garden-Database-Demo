...
map.getView().fit([14134757.764456, 4519800.937196, 14135423.692809, 4520410.817371], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">K-Garden : 한국전통정원 데이터베이스</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (100 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This site includs the basic infomations about Korean traditional gardens. Published at 2025. 01. 17.';
            }
